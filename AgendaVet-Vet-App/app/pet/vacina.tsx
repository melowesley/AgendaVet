...
export default function VacinaScreen() {
    ...
    return (
        <KeyboardAvoidingView style={[s.container, { backgroundColor: theme.background }]} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
            ...
            <FooterBtn onSave={handleSave} saving={saving} valid={!!nomeVacina} color={theme.primary} label="Registrar Vacina" theme={theme} />
...
function FooterBtn({ onSave, saving, valid, color, label, theme }: any) {
    return (
        <View style={s.footer}>
